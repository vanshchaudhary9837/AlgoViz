...
public class VisualizerFrame extends JFrame {
    ...
    public VisualizerFrame(){
        ...
        start.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                com.algoviz.visualizer.SortingVisualizer.startSort((String) selection.getSelectedItem());
            }
        });

        stepped.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                com.algoviz.visualizer.SortingVisualizer.stepped = stepped.isSelected();
            }
        });
        ...
        speed.addChangeListener(new ChangeListener() {
            public void stateChanged(ChangeEvent arg0) {
                ...
                validate();
                com.algoviz.visualizer.SortingVisualizer.sleep = speed.getValue();
            }
        });
        ...
        size.addChangeListener(new ChangeListener() {
            public void stateChanged(ChangeEvent arg0) {
                ...
                validate();
                com.algoviz.visualizer.SortingVisualizer.sortDataCount = size.getValue();
            }
        });
    ...
    public void preDrawArray(Integer[] squares){
        squarePanels = new JPanel[com.algoviz.visualizer.SortingVisualizer.sortDataCount];
        arrayWrapper.removeAll();
        // 90% of the windows height, divided by the size of the sorted array.
        sizeModifier =  (int) ((getHeight()*0.9)/(squarePanels.length));
        for(int i = 0; i< com.algoviz.visualizer.SortingVisualizer.sortDataCount; i++){
            squarePanels[i] = new JPanel();
            squarePanels[i].setPreferredSize(new Dimension(com.algoviz.visualizer.SortingVisualizer.blockWidth, squares[i]*sizeModifier));
